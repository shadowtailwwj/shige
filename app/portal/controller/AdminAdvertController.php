...
class AdminAdvertController extends AdminBaseController
{
    ...
    public function add()
    {
        ...
        $articleThemeFiles = $themeModel->getActionThemeFiles('portal/Advert/index');
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $result = $this->validate($data, 'AdminAdvert');
            ...
            $this->success('添加成功!', url('AdminAdvert/index'));
        }
    ...
    public function edit()
    {
        ...
        $post = Db::name('advert')->where('id',$id)->find();
    ...
    public function editPost()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $res = Db::name('advert')->where('id',$id)->update($data);;

            if ($res!=1) {
                $this->error('修改失败!');
            }

            $this->success('修改成功!', url('AdminAdvert/index'));
        }
    }
    ...
    public function delete()
    {
        ...
        $this->success('删除成功!', url('AdminAdvert/index'));
    }
