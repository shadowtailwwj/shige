...
class AdminAlbumController extends AdminBaseController
{
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $result = $this->validate($data, 'AdminAlbum');
            ...
            $res = Db::name('portal_album')->insert($data);;

            if ($res!=1) {
                $this->error('添加失败!');
            }

            $this->success('添加成功!', url('AdminAlbum/index'));
        }
    ...
    public function edit()
    {
        ...
        $post = Db::name('portal_album')->where('id',$id)->find();
        $cate = Db::name('portal_category_album')->select();
        $this->assign('cate', $cate);
    ...
    public function editPost()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $data['update_time'] = time();
            $res = Db::name('portal_album')->where('id',$id)->update($data);;

            if ($res!=1) {
                $this->error('修改失败!');
            }

            $this->success('修改成功!', url('AdminAlbum/index'));
        }
    }
    ...
    public function delete()
    {
        ...
        $this->success('删除成功!', url('AdminAlbum/index'));
    }
